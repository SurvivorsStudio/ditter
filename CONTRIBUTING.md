...
**열려 있는 PR 이 다루는 이슈를 직접 고치지 않는다.** 고쳐야 한다면 그 PR 에 먼저 알리고,
이어받을지 갈라설지를 정한 뒤에 손댄다. 실제로 한 번 어겼다 — PR #93 이 #86 을 정확히
고쳐 놓았는데 그 사실을 확인하지 않고 다른 작업에 얹어 먼저 머지했고(`4ad12a4`),
기여자에게 남은 것은 충돌난 PR 하나뿐이었다.
