...
| `username` | TEXT | NOT NULL | 읽기 전용 DB 계정(+ 운영 관찰을 쓰려면 `pg_read_all_stats` 롤도 필요 — [step-07-operations-monitoring.md](../todo/step-07-operations-monitoring.md)) |
...
| `max_rows` | INTEGER | NULL 허용, 기본값은 앱에서 정의 | 반환 행 수 제한 |
